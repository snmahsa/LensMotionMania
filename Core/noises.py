...
class Noise:
    ...
    def salt_and_pepper(self, amount=0.3, ratio=0.6):
        ...
        pepper_coords = tuple(np.random.randint(0, dim, num_pepper) for dim in self.image.shape)
        #Set
        sp_image[pepper_coords] = 0
        
        return sp_image
 
    def cornerـofـlight(self, frequency_range, amplitude):
        image = self.image
    ...
    def circle_periodic(self, frequency, amplitude):
        """
    ...
    def diamond_periodic(self, frequency, amplitude):
        """
        frequency: Determine the frequency of alternating noise
        amplitude: Determination of noise intensity
        """
